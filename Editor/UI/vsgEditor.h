...
class EditorMainWindowBase : public wxFrame {
   ...
   protected:
    ...
    virtual void EditorMainWindowBaseOnClose(wxCloseEvent& event) {
        event.Skip();
    }
    ...
    virtual void assetsTreeOnTreeSelChanged(wxTreeEvent& event) {
        event.Skip();
    }
    virtual void langAddOnButtonClick(wxCommandEvent& event) { event.Skip(); }
    virtual void langRemoveOnButtonClick(wxCommandEvent& event) {
        event.Skip();
    }
    virtual void languageListBoxOnListBoxDClick(wxListEvent& event) {
        event.Skip();
    }
    virtual void fontSearchOnSearchButton(wxCommandEvent& event) {
        event.Skip();
    }
    virtual void fontSearchOnText(wxCommandEvent& event) { event.Skip(); }
    virtual void fontsListOnListItemSelected(wxListEvent& event) {
        event.Skip();
    }
    ...
    virtual void finalSceneOnTreeSelChanged(wxTreeEvent& event) {
        event.Skip();
    }
   ...
   public:
    ...
    void m_splitter2OnIdle(wxIdleEvent&) {
        ...
        m_splitter2->Disconnect(
            wxEVT_IDLE,
            wxIdleEventHandler(EditorMainWindowBase::m_splitter2OnIdle), NULL,
            this);
    }
    ...
    void m_splitter3OnIdle(wxIdleEvent&) {
        ...
        m_splitter3->Disconnect(
            wxEVT_IDLE,
            wxIdleEventHandler(EditorMainWindowBase::m_splitter3OnIdle), NULL,
            this);
    }
...
class TransformPanelBase : public wxPanel {
   ...
   protected:
    ...
    virtual void copyScaleXOnButtonClick(wxCommandEvent& event) {
        event.Skip();
    }
    virtual void pasteScaleXOnButtonClick(wxCommandEvent& event) {
        event.Skip();
    }
    virtual void copyScaleYOnButtonClick(wxCommandEvent& event) {
        event.Skip();
    }
    virtual void pasteScaleYOnButtonClick(wxCommandEvent& event) {
        event.Skip();
    }
    virtual void copyScaleZOnButtonClick(wxCommandEvent& event) {
        event.Skip();
    }
    virtual void pasteScaleZOnButtonClick(wxCommandEvent& event) {
        event.Skip();
    }
    ...
    virtual void pasteScaleOnButtonClick(wxCommandEvent& event) {
        event.Skip();
    }
...
class TextPanelBase : public wxPanel {
   ...
   protected:
    ...
    virtual void vertAlignmentOnCombobox(wxCommandEvent& event) {
        event.Skip();
    }
