...
class EditorMainWindowBase : public wxFrame
{
	...
	protected:
		...
		wxPanel* bottomBar;
		wxFlexGridSizer* bottomBarSizer;
		wxListCtrl* logsList;
		wxFlexGridSizer* bottomBarLongTasksSizer;
		wxGauge* busyIcon;
		...
		virtual void languageListBoxOnListBoxDClick( wxListEvent& event ) { event.Skip(); }
		...
		virtual void showLogsMenuOnMenuSelection( wxCommandEvent& event ) { event.Skip(); }
	...
	public:
		...
		{
			m_splitter4->SetSashPosition( 800 );
			m_splitter4->Disconnect( wxEVT_IDLE, wxIdleEventHandler( EditorMainWindowBase::m_splitter4OnIdle ), NULL, this );
		}
...
class TransformPanelBase : public wxPanel
{
	...
	public:
		...
		TransformPanelBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxTAB_TRAVERSAL, const wxString& name = wxEmptyString );
...
class TextPanelBase : public wxPanel
{
	...
	protected:
		...
		virtual void fontColorPickerOnColourChanged( wxColourPickerEvent& event ) { event.Skip(); }
	...
	public:
		...
		TextPanelBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxTAB_TRAVERSAL, const wxString& name = wxEmptyString );
