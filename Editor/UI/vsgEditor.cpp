...
EditorMainWindowBase::EditorMainWindowBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_splitter4->Connect( wxEVT_IDLE, wxIdleEventHandler( EditorMainWindowBase::m_splitter4OnIdle ), NULL, this );
	m_splitter4->SetMinimumPaneSize( 100 );

	m_panel11 = new wxPanel( m_splitter4, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxFlexGridSizer* fgSizer23;
	fgSizer23 = new wxFlexGridSizer( 0, 1, 0, 0 );
	fgSizer23->AddGrowableCol( 0, 1 );
	fgSizer23->AddGrowableRow( 0, 1 );
	fgSizer23->SetFlexibleDirection( wxBOTH );
	fgSizer23->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_splitter2 = new wxSplitterWindow( m_panel11, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxSP_3D );
	...
	languageListBox = new wxListCtrl( localizationPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLC_SMALL_ICON );
	...
	fgSizer23->Add( m_splitter2, 1, wxEXPAND, 5 );


	m_panel11->SetSizer( fgSizer23 );
	m_panel11->Layout();
	fgSizer23->Fit( m_panel11 );
	bottomBar = new wxPanel( m_splitter4, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	bottomBarSizer = new wxFlexGridSizer( 2, 1, 0, 0 );
	bottomBarSizer->AddGrowableCol( 0, 1 );
	bottomBarSizer->AddGrowableRow( 0, 1 );
	bottomBarSizer->AddGrowableRow( 1 );
	bottomBarSizer->SetFlexibleDirection( wxBOTH );
	bottomBarSizer->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	logsList = new wxListCtrl( bottomBar, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLC_SMALL_ICON );
	bottomBarSizer->Add( logsList, 1, wxALL|wxEXPAND, 0 );

	bottomBarLongTasksSizer = new wxFlexGridSizer( 0, 2, 0, 0 );
	bottomBarLongTasksSizer->SetFlexibleDirection( wxVERTICAL );
	bottomBarLongTasksSizer->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
	...
	bottomBarSizer->Add( bottomBarLongTasksSizer, 0, wxEXPAND, 5 );


	bottomBar->SetSizer( bottomBarSizer );
	bottomBar->Layout();
	bottomBarSizer->Fit( bottomBar );
	m_splitter4->SplitHorizontally( m_panel11, bottomBar, 800 );
	bSizer1->Add( m_splitter4, 1, wxEXPAND, 5 );
	...
	wxMenuItem* showLogsMenu;
	showLogsMenu = new wxMenuItem( m_menu2, wxID_ANY, wxString( wxT("Show Logs") ) , wxEmptyString, wxITEM_NORMAL );
	m_menu2->Append( showLogsMenu );
	...
	languageListBox->Connect( wxEVT_COMMAND_LIST_ITEM_RIGHT_CLICK, wxListEventHandler( EditorMainWindowBase::languageListBoxOnListBoxDClick ), NULL, this );
	...
	m_menu2->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( EditorMainWindowBase::showLogsMenuOnMenuSelection ), this, showLogsMenu->GetId());
...
EditorMainWindowBase::~EditorMainWindowBase()
{
	...
	languageListBox->Disconnect( wxEVT_COMMAND_LIST_ITEM_RIGHT_CLICK, wxListEventHandler( EditorMainWindowBase::languageListBoxOnListBoxDClick ), NULL, this );
...
TransformPanelBase::TransformPanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	copyPosX = new wxButton( this, wxID_ANY, wxT("CX"), wxDefaultPosition, wxSize( 16,16 ), wxBORDER_NONE );
	bSizer16->Add( copyPosX, 0, wxALL, 0 );

	pastePosX = new wxButton( this, wxID_ANY, wxT("PX"), wxDefaultPosition, wxSize( 16,16 ), wxBORDER_NONE );
	bSizer16->Add( pastePosX, 0, wxALL, 0 );


	fgSizer4->Add( bSizer16, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0 );

	wxBoxSizer* bSizer17;
	bSizer17 = new wxBoxSizer( wxHORIZONTAL );

	copyPosY = new wxButton( this, wxID_ANY, wxT("CY"), wxDefaultPosition, wxSize( 16,16 ), wxBORDER_NONE );
	bSizer17->Add( copyPosY, 0, wxALL, 0 );

	pastePosY = new wxButton( this, wxID_ANY, wxT("PY"), wxDefaultPosition, wxSize( 16,16 ), wxBORDER_NONE );
	bSizer17->Add( pastePosY, 0, wxALL, 0 );


	fgSizer4->Add( bSizer17, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );

	wxBoxSizer* bSizer18;
	bSizer18 = new wxBoxSizer( wxHORIZONTAL );

	copyPosZ = new wxButton( this, wxID_ANY, wxT("CZ"), wxDefaultPosition, wxSize( 16,16 ), wxBORDER_NONE );
	bSizer18->Add( copyPosZ, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 0 );

	pastePosZ = new wxButton( this, wxID_ANY, wxT("PZ"), wxDefaultPosition, wxSize( 16,16 ), wxBORDER_NONE );
	bSizer18->Add( pastePosZ, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 0 );


	fgSizer4->Add( bSizer18, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	copyPos = new wxButton( this, wxID_ANY, wxT("Copy"), wxDefaultPosition, wxSize( 16,16 ), 0 );
	bSizer20->Add( copyPos, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 0 );

	pastePos = new wxButton( this, wxID_ANY, wxT("Paste"), wxDefaultPosition, wxSize( 16,16 ), 0 );
	bSizer20->Add( pastePos, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 0 );


	fgSizer4->Add( bSizer20, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	copyScaleX = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxSize( 16,16 ), 0 );
	bSizer22->Add( copyScaleX, 0, wxALL, 0 );

	pasteScaleX = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxSize( 16,16 ), 0 );
	bSizer22->Add( pasteScaleX, 0, wxALL, 0 );


	fgSizer2->Add( bSizer22, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );

	wxBoxSizer* bSizer23;
	bSizer23 = new wxBoxSizer( wxHORIZONTAL );

	copyScaleY = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxSize( 16,16 ), 0 );
	bSizer23->Add( copyScaleY, 0, wxALL, 0 );

	pasteScaleY = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxSize( 16,16 ), 0 );
	bSizer23->Add( pasteScaleY, 0, wxALL, 0 );


	fgSizer2->Add( bSizer23, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );

	wxBoxSizer* bSizer24;
	bSizer24 = new wxBoxSizer( wxHORIZONTAL );

	copyScaleZ = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxSize( 16,16 ), 0 );
	bSizer24->Add( copyScaleZ, 0, wxALL, 0 );

	pasteScaleZ = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxSize( 16,16 ), 0 );
	bSizer24->Add( pasteScaleZ, 0, wxALL, 0 );


	fgSizer2->Add( bSizer24, 1, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0 );
	...
	copyScale = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxSize( 16,16 ), 0 );
	bSizer26->Add( copyScale, 0, wxALL, 0 );

	pasteScale = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxSize( 16,16 ), 0 );
	...
	copyPosX->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyPosXOnButtonClick ), NULL, this );
	pastePosX->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pastePosXOnButtonClick ), NULL, this );
	copyPosY->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyPosYOnButtonClick ), NULL, this );
	pastePosY->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pastePosYOnButtonClick ), NULL, this );
	copyPosZ->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyPosZOnButtonClick ), NULL, this );
	pastePosZ->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pastePosZOnButtonClick ), NULL, this );
	...
	copyPos->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyPosOnButtonClick ), NULL, this );
	pastePos->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pastePosOnButtonClick ), NULL, this );
	copyScaleX->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyScaleXOnButtonClick ), NULL, this );
	pasteScaleX->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pasteScaleXOnButtonClick ), NULL, this );
	copyScaleY->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyScaleYOnButtonClick ), NULL, this );
	pasteScaleY->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pasteScaleYOnButtonClick ), NULL, this );
	copyScaleZ->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyScaleZOnButtonClick ), NULL, this );
	pasteScaleZ->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pasteScaleZOnButtonClick ), NULL, this );
	...
	copyScale->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyScaleOnButtonClick ), NULL, this );
	pasteScale->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pasteScaleOnButtonClick ), NULL, this );
...
TransformPanelBase::~TransformPanelBase()
{
	...
	copyPosX->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyPosXOnButtonClick ), NULL, this );
	pastePosX->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pastePosXOnButtonClick ), NULL, this );
	copyPosY->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyPosYOnButtonClick ), NULL, this );
	pastePosY->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pastePosYOnButtonClick ), NULL, this );
	copyPosZ->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyPosZOnButtonClick ), NULL, this );
	pastePosZ->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pastePosZOnButtonClick ), NULL, this );
	...
	copyPos->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyPosOnButtonClick ), NULL, this );
	pastePos->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pastePosOnButtonClick ), NULL, this );
	copyScaleX->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyScaleXOnButtonClick ), NULL, this );
	pasteScaleX->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pasteScaleXOnButtonClick ), NULL, this );
	copyScaleY->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyScaleYOnButtonClick ), NULL, this );
	pasteScaleY->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pasteScaleYOnButtonClick ), NULL, this );
	copyScaleZ->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyScaleZOnButtonClick ), NULL, this );
	pasteScaleZ->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pasteScaleZOnButtonClick ), NULL, this );
	...
	copyScale->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::copyScaleOnButtonClick ), NULL, this );
	pasteScale->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TransformPanelBase::pasteScaleOnButtonClick ), NULL, this );
...
TextPanelBase::TextPanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	wxBoxSizer* bSizer6;
	bSizer6 = new wxBoxSizer( wxVERTICAL );
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, wxT("Font:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1->Wrap( -1 );
	...
	fontCmb = new wxComboBox( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_SORT );
	fgSizer4->Add( fontCmb, 1, wxALL|wxEXPAND, 0 );


	fgSizer1->Add( fgSizer4, 1, wxEXPAND, 5 );

	m_staticText3 = new wxStaticText( this, wxID_ANY, wxT("Text:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText3->Wrap( -1 );
	...
	valueTxt = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE );
	...
	m_staticText13 = new wxStaticText( this, wxID_ANY, wxT("Color:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText13->Wrap( -1 );
	fgSizer1->Add( m_staticText13, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxSHAPED, 5 );
	...
	fontColorPicker = new wxColourPickerCtrl( this, wxID_ANY, *wxBLACK, wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE );
	fgSizer25->Add( fontColorPicker, 1, wxEXPAND, 0 );


	fgSizer1->Add( fgSizer25, 1, wxEXPAND, 0 );

	m_staticText14 = new wxStaticText( this, wxID_ANY, wxT("Offset:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	offsetXEdit = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	offsetXEdit->SetMinSize( wxSize( 50,-1 ) );

	fgSizer26->Add( offsetXEdit, 1, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 0 );

	offsetYEdit = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	offsetYEdit->SetMinSize( wxSize( 50,-1 ) );

	fgSizer26->Add( offsetYEdit, 1, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 0 );

	offsetZEdit = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	horAxisXEdit = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	horAxisXEdit->SetMinSize( wxSize( 50,-1 ) );

	fgSizer28->Add( horAxisXEdit, 1, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 0 );

	horAxisYEdit = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	horAxisYEdit->SetMinSize( wxSize( 50,-1 ) );

	fgSizer28->Add( horAxisYEdit, 1, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 0 );

	horAxisZEdit = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	horAxisZEdit->SetMinSize( wxSize( 50,-1 ) );

	fgSizer28->Add( horAxisZEdit, 1, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 0 );
	...
	vertAxisXEdit = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	vertAxisXEdit->SetMinSize( wxSize( 50,-1 ) );

	fgSizer27->Add( vertAxisXEdit, 1, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 0 );

	vertAxisYEdit = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	vertAxisYEdit->SetMinSize( wxSize( 50,-1 ) );

	fgSizer27->Add( vertAxisYEdit, 1, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 0 );

	vertAxisZEdit = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	vertAxisZEdit->SetMinSize( wxSize( 50,-1 ) );

	fgSizer27->Add( vertAxisZEdit, 1, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 0 );


	fgSizer1->Add( fgSizer27, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );

	m_staticText17 = new wxStaticText( this, wxID_ANY, wxT("Horizontal\nAlignment:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	horAlignment = new wxComboBox( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY );
	...
	vertAlignment = new wxComboBox( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY );
	...
	lineSpacingEdit = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	// Connect Events
	fontCmb->Connect( wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler( TextPanelBase::fontCmbOnCombobox ), NULL, this );
	valueTxt->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::valueTxtOnText ), NULL, this );
	fontColorPicker->Connect( wxEVT_COMMAND_COLOURPICKER_CHANGED, wxColourPickerEventHandler( TextPanelBase::fontColorPickerOnColourChanged ), NULL, this );
	offsetXEdit->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::offsetXEditOnText ), NULL, this );
	offsetYEdit->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::offsetYEditOnText ), NULL, this );
	offsetZEdit->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::offsetZEditOnText ), NULL, this );
	horAxisXEdit->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::horAxisXEditOnText ), NULL, this );
	horAxisYEdit->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::horAxisYEditOnText ), NULL, this );
	horAxisZEdit->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::horAxisZEditOnText ), NULL, this );
	vertAxisXEdit->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::vertAxisXEditOnText ), NULL, this );
	vertAxisYEdit->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::vertAxisYEditOnText ), NULL, this );
	vertAxisZEdit->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::vertAxisZEditOnText ), NULL, this );
	horAlignment->Connect( wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler( TextPanelBase::horAlignmentOnCombobox ), NULL, this );
	vertAlignment->Connect( wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler( TextPanelBase::vertAlignmentOnCombobox ), NULL, this );
	lineSpacingEdit->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::lineSpacingEditOnText ), NULL, this );
}

TextPanelBase::~TextPanelBase()
{
	// Disconnect Events
	fontCmb->Disconnect( wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler( TextPanelBase::fontCmbOnCombobox ), NULL, this );
	valueTxt->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::valueTxtOnText ), NULL, this );
	fontColorPicker->Disconnect( wxEVT_COMMAND_COLOURPICKER_CHANGED, wxColourPickerEventHandler( TextPanelBase::fontColorPickerOnColourChanged ), NULL, this );
	offsetXEdit->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::offsetXEditOnText ), NULL, this );
	offsetYEdit->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::offsetYEditOnText ), NULL, this );
	offsetZEdit->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::offsetZEditOnText ), NULL, this );
	horAxisXEdit->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::horAxisXEditOnText ), NULL, this );
	horAxisYEdit->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::horAxisYEditOnText ), NULL, this );
	horAxisZEdit->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::horAxisZEditOnText ), NULL, this );
	vertAxisXEdit->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::vertAxisXEditOnText ), NULL, this );
	vertAxisYEdit->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::vertAxisYEditOnText ), NULL, this );
	vertAxisZEdit->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::vertAxisZEditOnText ), NULL, this );
	horAlignment->Disconnect( wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler( TextPanelBase::horAlignmentOnCombobox ), NULL, this );
	vertAlignment->Disconnect( wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler( TextPanelBase::vertAlignmentOnCombobox ), NULL, this );
	lineSpacingEdit->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( TextPanelBase::lineSpacingEditOnText ), NULL, this );
