...
CREATE_STATE_WRAPPER(TransformPanel, 0xdd, 0x8, 0x5b, 0xf6, 0x5d, 0x78, 0x46,
...
public:
  ...
  Vandrouka::Ref<ITransformEntry> GetDataModel() { return _dataModel; }
...
private:
  ...
  Vandrouka::Ref<ITransformEntry> _dataModel;
