...
void TextPanel::AddRef() {}

void TextPanel::Release() {}

bool TextPanel::QueryInterface(const InterfaceId &id, void **o) {
  return false;
}

void TextPanel::OnNext(Vandrouka::Ref<IMessage> msg) {
  _processor->Process(_stateWrapper, msg, _sinkWrapper);
}

void TextPanel::OnError(Vandrouka::Ref<IError> error) {
  _sinkWrapper->SubmitError(error);
}

void TextPanel::OnComplete() {}

void TextPanel::SubmitMessage(Vandrouka::Ref<IMessage> msg) {}
