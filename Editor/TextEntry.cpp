...
class TextEntry
    : public EntryBase<TextEntry, ITextEntry, IEntry, ISerializable> {
  using Base = EntryBase<TextEntry, ITextEntry, IEntry, ISerializable>;
...
//
// std::shared_ptr<Entry> TextEntry::CreateView(std::shared_ptr<AsyncQueue>
// sync) {
...
// }
//
// Result<bool> TextEntry::CloneFrom(std::shared_ptr<Entry> entry) {
