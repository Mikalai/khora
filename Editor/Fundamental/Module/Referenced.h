...
#include <Fundamental/Interface/IToString.h>

#define CREATE_STATE_WRAPPER(P, X, ...)                                        \
  namespace P {                                                                \
  class X;                                                                     \
  ...
  template <> struct GetIID<P::I##X##StateWrapper> {                           \
    static constexpr InterfaceId Id = {{__VA_ARGS__}};                         \
  };                                                                           \
  }                                                                            \
  namespace P {                                                                \
  class X##StateWrapper                                                        \
      : public ::Vandrouka::Fundamental::Private::ReferenceCountedBase<        \
            X##StateWrapper, I##X##StateWrapper> {                             \
  public:                                                                      \
