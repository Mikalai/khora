...
public:
    ...
    virtual void SetOverride(bool flag) { }
    virtual bool GetOverride() const { return false; }

    virtual void SetPosition(vsg::dvec3 value) { }
    virtual vsg::dvec3 GetPosition() const { return {}; }

    virtual void SetScale(vsg::dvec3 value) { }
    virtual vsg::dvec3 GetScale() const { return { 1,1,1 }; }

    virtual void SetOrientation(vsg::dquat value) { }
...
public:
    ...
    TransformEntryView(std::shared_ptr<TransformEntry> dataModel, std::shared_ptr<AsyncQueue> syncContext)
        : _model{ dataModel }
        , _sync{ syncContext } {
