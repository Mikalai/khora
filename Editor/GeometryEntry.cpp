...
class GeometryEntry
    : public EntryBase<Derived, IGeometryEntry, I..., IEntry, ISerializable> {
...
public:
  using Interfaces =
      QueryInterfaces<GeometryPackageEntry, IGeometryEntry, IPackageEntry,
...
IReferenced *CreateGeometryPackageEntry() {
  static_assert(std::is_base_of_v<IReferenced, GeometryPackageEntry>);
  return static_cast<IGeometryEntry *>(new GeometryPackageEntry());
}
...
IReferenced *CreateGeometryProxyEntry() {
  static_assert(std::is_base_of_v<IReferenced, GeometryProxyEntry>);
  return static_cast<IGeometryEntry *>(new GeometryProxyEntry());
}
