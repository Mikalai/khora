...
std::string g_messageTypeTable[]{"MsgMoneyChanged",
...
const std::string& ToString(MessageType type) {
    static_assert((sizeof(g_messageTypeTable) /
                   sizeof(g_messageTypeTable[0])) == (int)MessageType::Count,
                  "Not enough message strings");
