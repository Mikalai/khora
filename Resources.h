...
const std::string str_coin_5_material = "coin_5_material";
const std::string str_coin_1_material = "coin_1_material";
const std::string str_philosophy_material = "philosophy_material";
...
const std::string str_city_card = "city_card";
...
const std::string str_city_level = "city_level";
const std::string str_economy = "economy";
const std::string str_culture = "culture";
const std::string str_military = "military";
const std::string str_population = "population";
const std::string str_army = "army";
const std::string str_glory = "glory";
const std::string str_points = "points";
const std::string str_tax = "tax";
const std::string str_dice = "dice";
const std::string str_achieve = "achieve";
const std::string str_mark_90 = "mark_90";
const std::string str_action_front = "action_front";
const std::string str_action_back = "action_back";
